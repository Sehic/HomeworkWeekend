...
public class mainTask3 {
	...
	public static void main(String[] args) {
		Classroom c1 = new Classroom("Class 1", 21);
		Classroom c2 = new Classroom("Class 2", 33);
		Classroom c3 = new Classroom("Class 3", 23);
		Classroom c4 = new Classroom("Class 1", 19);
		Classroom c5 = new Classroom("Class 2", 35);
		Classroom c6 = new Classroom("Class 3", 17);
		Classroom c7 = new Classroom("Class 1", 33);
		Classroom c8 = new Classroom("Class 2", 41);
		Classroom c9 = new Classroom("Class 3", 19);
		Director d1 = new Director("Mujo Mujic", 1970);
		Director d2 = new Director("Haso Hasic", 1965);
		Director d3 = new Director("Suljo Suljic", 1980);
		...
		School []arr = {s1,s2,s3}; 
		//Tek sam se ovdje sjetio da mogu ovako inicijalizirati niz :(
		System.out.println("Name of class with most students: "+getNameOfClassWithMostStudents(s1));
		System.out.println("Podaci o skoli sa najmladjim direktorom: \n"+getSchoolWithYoungestDirector(arr));
		System.out.println("Ime skole koja ima vise studenata: "+getNameOfSchoolWithMoreStudents(s2, s3));

	}
	
	/**
	 * This method counts witch class have more students
	 * @param s School from class school
	 ...
	 * @param schools array of schools from class School
	...
	public static School getSchoolWithYoungestDirector(School [] schools){
		School s = new School(schools[0].getNameOfSchool(), schools[0].getDirectorOfSchool(), schools[0].getClassrooms());
		...
		for(int i = 0; i<schools.length; i++){
			if(schools[i].getDirectorOfSchool().getYearOfBirth()>temp){
				...
				s = new School(schools[i].getNameOfSchool(), schools[i].getDirectorOfSchool(), schools[i].getClassrooms());
			}
		}
		return s;
	}
	 ...
	 * @param s1 school number 1 from class School
	 * @param s2 school number 2 from class School
